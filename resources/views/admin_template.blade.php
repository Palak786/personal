...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('bower_components/adminlte/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css') }}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('bower_components/adminlte/https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css') }}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="{{ asset('bower_components/adminlte/http://almsaeedstudio.com') }}">Almsaeed Studio</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- Morris.js charts -->
<script src="{{ asset('bower_components/adminlte/https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js') }}"></script>
...
<!-- daterangepicker -->
<script src="{{ asset('bower_components/adminlte/https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js') }}"></script>
